package com.amdocs.catalogservice.web.controllers;

import com.amdocs.catalogservice.entities.Product;
import com.amdocs.catalogservice.exceptions.ProductNotFoundException;
import com.amdocs.catalogservice.services.ProductService;
...
public class ProductController {
    ...
    public Product productBy(@PathVariable String code) {
        log.info("Finding product by code :" + code);
        return productService.findProductByCode(code)
                .orElseThrow(() -> new ProductNotFoundException("Product with code [" + code + "] doesn't exist"));
    }
